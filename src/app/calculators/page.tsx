...
const calculators = [
  ...
  { icon: Percent, label: "CAGR Calculator", desc: "Calculate Compound Annual Growth Rate for any investment.", href: "/calculators/cagr", color: "bg-rose-600", example: "Investment grew ₹1L to ₹3L in 8 years = 14.7% CAGR" },
  { icon: ArrowUpDown, label: "SWP Calculator", desc: "Calculate Systematic Withdrawal Plan from mutual funds.", href: "/calculators/swp", color: "bg-teal-600", example: "Withdraw ₹20,000/month from ₹50L corpus" },
  { icon: Calculator, label: "FD Calculator", desc: "Calculate Fixed Deposit maturity amount and interest earned.", href: "/calculators/fd", color: "bg-orange-600", example: "₹5L FD @7% for 3 years = ₹6.13 Lakh" },
  { icon: TrendingUp, label: "Income Tax Calculator", desc: "Calculate income tax liability under old and new tax regime.", href: "/calculators/income-tax", color: "bg-indigo-600", example: "₹12L income: Old regime vs New regime comparison" },
]
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-8">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">Free, accurate financial calculators to help you plan your investments, loans, and retirement. Built for Indian investors.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {calculators.map((calc) => (
          <Link key={calc.label} href={calc.href} className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-5 hover:border-[#1E40AF] hover:shadow-lg transition-all">
            ...
            <h3 className="font-bold text-base mb-2 group-hover:text-[#1E40AF] transition-colors">{calc.label}</h3>
