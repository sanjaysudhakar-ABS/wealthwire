...
export const metadata: Metadata = {
  title: "Disclaimer | WealthWire",
  description: "Important disclaimers for WealthWire — investment, affiliate, advertiser, and accuracy disclosures.",
}
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-10 text-gray-700 dark:text-gray-300">
        ...
        <section>
          <p>
            Please read the following disclaimers carefully before using WealthWire
            (abscorp.xyz), operated by Athena Business Solutions. By using our site, you acknowledge and
        ...
        <section className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <div className="rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-700 p-5 mb-4">
            <p className="font-bold text-red-800 dark:text-red-400 mb-2">
              WealthWire is NOT registered with SEBI.
            </p>
          ...
          <div className="space-y-3">
            <p>
              ...
              and any other financial content published on WealthWire are strictly for
            ...
            <p>
              WealthWire and its contributors are not responsible for any trading or investment
        ...
        <section className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <p>
            WealthWire participates in affiliate marketing programmes. This means we may earn
        ...
        <section className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <p>
            WealthWire displays advertisements served by Google AdSense. These advertisements
            ...
            not constitute an endorsement of the advertised product or service by WealthWire.
          </p>
          <p className="mt-3">
        ...
        <section className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <p>
            While we strive to provide accurate and timely financial information, WealthWire
        ...
        <section className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <p>
            &copy; {new Date().getFullYear()} WealthWire, a service of Athena Business Solutions. All rights
            reserved. The content, design, logos, and trademarks of WealthWire are protected by Indian and
